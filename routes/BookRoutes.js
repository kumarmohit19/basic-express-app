...
const { validateBookRequest, validateBookOwner } = require("../middlewares/requestValidator");
...
router.delete("/:id",[ authenticateUser, validateBookOwner ], bookController.deleteBookById);
